...
<?php include '../home/navbar.html'; ?>
    <div class="container">
        ...
        <h3>When do I need to format my SSD?</h3>
        ...
        <h3>Prepare to format the SSD hard drive</h3>
        ...
        <h3>How to format in Windows</h3>
        ...
        <h3>Is my data really deleted?</h3>
