...
<div class="wrapper container-fluid">
    ...
    ?>
                <div class="col-md-3 mt-2">
                    <div class="card custom-col">
                        <a href="" class="list-group-item align-items-center">
                            <img src="<?php echo $row["imageLink"]?>" class="p-2 object-fit-contain home-custom-image" alt="Product 3">
                        </a>
        ...
        <a href="#" class="btn btn-danger home-btn-showmore ">SHOW MORE</a>
        </div>
        </div>
        </div>
        <br>
