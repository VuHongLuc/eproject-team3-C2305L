...
<body>
    <div id="main-menu" class="d-flex flex-wrap justify-content-center">
            ...
            <div class="category-menu row text-center  d-flex flex-wrap justify-content-around">
                ...
                <div class="menu-item col-lg-2 col-md-3  col-6 p-3">
                    <a href="../listPage/viewListCategory.php?category=4" class="list-group-item">
                        ...
                        <p class="menu-item_name m-1  font-weight_bold text-center text-uppercase padding ">Memory Card
                        </p>
                    </a>
                </div>
                <div class="menu-item col-lg-2 col-md-3  col-6 p-3">
        ...
        <!-- Brand -->
        <!-- <div class="main-menu_brands p-3  "> -->
            <!-- <h1 class="main-menu_name text-center text-uppercase p-3">Brands</h1> -->
            ...
            <!-- <div class="category-menu row text-center d-flex flex-wrap justify-content-around   "> -->
                ...
                <!-- <div class="menu-item col-lg-2 col-md-4  col-6 p-3"> -->
                    <!-- <a href="../listPage/viewListBrand.php?brand=6" class="list-group-item"> -->
                        ...
                        <!-- <p class="menu-item_name m-1  font-weight_bold text-center text-uppercase padding ">Transcend -->
                        <!-- </p> -->
                    <!-- </a> -->
                <!-- </div> -->
            <!-- </div> -->
